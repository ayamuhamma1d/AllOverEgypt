    ...
    <>
                ...
                <Card className='shadow h-100  border-0'>
                  <div className="position-relative">   <Card.Img variant="top" src={item.img} className=' p-2 rounded-2' />
                    ...
                    <Link
                      ...
                      <h5 className=" text-white fw-bold  ">{item.title}</h5></Link>
      ...
      <section className=" ">
        <Container className=" p-5">
          ...
          <MySwiper  tripType='StandardFourPackages'/>
        </Container>
      </section>
      ...
      <section id="Accordion" className="py-5 bg-white">
        <Container>
