      ...
      <MDBFooter bgColor='light' className='text-center text-lg-start text-muted  '>
        <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom'>
          <div className='me-5 d-none d-lg-block'>
            <span className='text__color'>Get connected with us on social networks:</span>
          </div>
          ...
          <MDBContainer className='text-center text-md-start mt-5'>
            <MDBRow className='mt-3'>
              <MDBCol md="3" lg="4" xl="3" className='mx-auto mb-4 '>
                <h6 className='text-uppercase fw-bold mb-4 secondary-color-text'>
              ...
              <MDBCol md="4" lg="3" xl="3" className='mx-auto mb-md-0 mb-4 useful-links'>
                ...
                >
                  ...
                  <span className='text-muted '>Info@allover-egypt.com</span>
                </a>
                ...
                >
                  ...
                  <span className='text-muted  '>(+2) 01155430742</span>
                </a>            </MDBCol>
            </MDBRow>
          </MDBContainer>
        </section>

        <div className='text-center p-4 secondary-color  opacity-75' >
          <span className='me-2'>  © Copyright 2024 <Link className=' text-muted fw-bold ms-1 ' to='/home'>
